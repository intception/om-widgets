...
(deftest build-page-boundaries
  ...
  (testing "normal page info"
    ...
    (is (= {:start 1 :end 2} (grid/build-page-boundaries {:current-page 1
                                                          :page-size 2
                                                          :total-items 6})))
    ;; [[1 2] *[3 4]* [5 6]] / 3-4 of 6
    (is (= {:start 3 :end 4} (grid/build-page-boundaries {:current-page 2
                                                          :page-size 2
                                                          :total-items 6})))
    ;; [[1 2] [3 4] *[5 6]*] / 5-6 of 6
    (is (= {:start 5 :end 6} (grid/build-page-boundaries {:current-page 3
                                                          :page-size 2
                                                          :total-items 6}))))
  (testing "without items"
    ;; []  / 0-0 of 0
    (is (= {:start 0 :end 0} (grid/build-page-boundaries {:current-page 1
                                                          :page-size 1
                                                          :total-items 0}))))
  (testing "1 item"
    ;; [*[1]*]  / 1-1 of 1
    (is (= {:start 1 :end 1} (grid/build-page-boundaries {:current-page 1
                                                          :page-size 1
                                                          :total-items 1}))))
  (testing "2 pages, and the last page with just 1 item"
    ;; [*[1 2 3 4]* [5]] / 1-4 of 5
    (is (= {:start 1 :end 4} (grid/build-page-boundaries {:current-page 1
                                                          :page-size 4
                                                          :total-items 5})))
    ;; [[1 2 3 4] *[5]*] / 5-5 of 5
    (is (= {:start 5 :end 5} (grid/build-page-boundaries {:current-page 2
                                                          :page-size 4
                                                          :total-items 5}))))
  (testing "2 pages, and the last page (rest) smallest than the current page size"
    ...
    ;; [[1 2 3 4] *[5 6]*] / 5-6 of 6
   (is (= {:start 5 :end 6} (grid/build-page-boundaries {:current-page 2
                                                         :page-size 4
                                                         :total-items 6})))))
