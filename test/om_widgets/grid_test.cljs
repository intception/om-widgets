...
(deftest data-page
  ...
  (let [chan (chan)]
    ...
    ;FAIL in (om-widgets.grid-test/data-page) (:)
    ;grid data-page non-empty with index
    ;expected: (= (quote (5 6)) (grid/data-page {:rows rows, :index 1} 1 page-size chan))
    ;  actual: (not (= (5 6) (4 5 6)))
